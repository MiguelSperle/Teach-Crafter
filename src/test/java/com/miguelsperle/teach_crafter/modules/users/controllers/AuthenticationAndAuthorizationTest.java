...
public class AuthenticationAndAuthorizationTest {
    ...
    @Test
    @DisplayName("Should not be able to update user name if authorization token is invalid")
    public void should_not_be_able_to_update_user_name_if_authorization_token_is_invalid() throws Exception {
        ResultActions result = this.mvc.perform(MockMvcRequestBuilders.put("/users/update-name")
                .header("Authorization", "d2dx23zqr23fc24mu78cx9qwWmv2cçAc2t3mfOt2ÇzExm0mvcKrt6ACSmcQdwEm50kc0kmCkc"));

        String expectedMessage = "Invalid authorization token";
    ...
    @Test
    @DisplayName("Should not be able to update user username if authorization token is invalid")
    public void should_not_be_able_to_update_user_username_if_authorization_token_is_invalid() throws Exception {
        ResultActions result = this.mvc.perform(MockMvcRequestBuilders.put("/users/update-username")
                .header("Authorization", "d2dx23zqr23fc24mu78cx9qwWmv2cçAc2t3mfOt2ÇzExm0mvcKrt6ACSmcQdwEm50kc0kmCkc"));
    ...
    @Test
    @DisplayName("Should not be able to update user email if authorization token is invalid")
    public void should_not_be_able_to_update_user_email_if_authorization_token_is_invalid() throws Exception {
        ResultActions result = this.mvc.perform(MockMvcRequestBuilders.put("/users/update-email")
                .header("Authorization", "d2dx23zqr23fc24mu78cx9qwWmv2cçAc2t3mfOt2ÇzExm0mvcKrt6ACSmcQdwEm50kc0kmCkc"));
    ...
    @Test
    @DisplayName("Should not be able to update loggedUser password if authorization token is invalid")
    public void should_not_be_able_to_update_loggedUser_password_if_authorization_token_is_invalid() throws Exception {
        ResultActions result = this.mvc.perform(MockMvcRequestBuilders.put("/users/update-password")
                .header("Authorization", "d2dx23zqr23fc24mu78cx9qwWmv2cçAc2t3mfOt2ÇzExm0mvcKrt6ACSmcQdwEm50kc0kmCkc"));
    ...
    @Test
    @DisplayName("Should not be able to update user image if authorization token is invalid")
    public void should_not_be_able_to_update_user_image_if_authorization_token_is_invalid() throws Exception {
        ResultActions result = this.mvc.perform(MockMvcRequestBuilders.multipart(HttpMethod.PUT, ("/users/update-image"))
                .header("Authorization", "d2dx23zqr23fc24mu78cx9qwWmv2cçAc2t3mfOt2ÇzExm0mvcKrt6ACSmcQdwEm50kc0kmCkc"));
    ...
    @Test
    @DisplayName("Should not be able to fetch authenticated user profile if authorization token is invalid")
    public void should_not_be_able_to_fetch_authenticated_user_profile_if_authorization_token_is_invalid() throws Exception {
        ResultActions result = this.mvc.perform(MockMvcRequestBuilders.get("/users/profile")
                .header("Authorization", "d2dx23zqr23fc24mu78cx9qwWmv2cçAc2t3mfOt2ÇzExm0mvcKrt6ACSmcQdwEm50kc0kmCkc"));
    ...
    @Test
    @DisplayName("Should not be able to subscribe in the course if authorization token is invalid")
    public void should_not_be_able_to_subscribe_in_the_course_if_authorization_token_is_invalid() throws Exception {
        CoursesEntity course = new CoursesEntity();
        course.setId(String.valueOf(UUID.randomUUID()));
    ...
    @Test
    @DisplayName("Should not be able to unsubscribe from a course if authorization token is invalid")
    public void should_not_be_able_to_unsubscribe_from_a_course_if_authorization_token_is_invalid() throws Exception {
        CoursesEntity course = new CoursesEntity();
        course.setId(String.valueOf(UUID.randomUUID()));
    ...
    @Test
    @DisplayName("Should not be able to create a course if authorization token is invalid")
    public void should_not_be_able_to_create_a_course_if_authorization_token_is_invalid() throws Exception {
        ResultActions result = this.mvc.perform(MockMvcRequestBuilders.post("/courses/create")
                .header("Authorization", "d2dx23zqr23fc24mu78cx9qwWmv2cçAc2t3mfOt2ÇzExm0mvcKrt6ACSmcQdwEm50kc0kmCkc"));
    ...
    @Test
    @DisplayName("Should not be able to update course name if authorization token is invalid")
    public void should_not_be_able_to_update_course_name_if_authorization_token_is_invalid() throws Exception {
        CoursesEntity course = new CoursesEntity();
        course.setId(String.valueOf(UUID.randomUUID()));
    ...
    @Test
    @DisplayName("Should not be able to update course description if authorization token is invalid")
    public void should_not_be_able_to_update_course_description_if_authorization_token_is_invalid() throws Exception {
        CoursesEntity course = new CoursesEntity();
        course.setId(String.valueOf(UUID.randomUUID()));
    ...
    @Test
    @DisplayName("Should not be able to fetch all courses created by creator user if authorization token is invalid")
    public void should_not_be_able_to_fetch_all_courses_created_by_creator_user_if_authorization_token_is_invalid() throws Exception {
        ResultActions result = this.mvc.perform(MockMvcRequestBuilders.get("/courses/creator-owned")
                .header("Authorization", "d2dx23zqr23fc24mu78cx9qwWmv2cçAc2t3mfOt2ÇzExm0mvcKrt6ACSmcQdwEm50kc0kmCkc"));
    ...
    @Test
    @DisplayName("Should not be able to deactivate a course if authorization token is invalid")
    public void should_not_be_able_to_deactivate_a_course_if_authorization_token_is_invalid() throws Exception {
        CoursesEntity course = new CoursesEntity();
        course.setId(String.valueOf(UUID.randomUUID()));
    ...
    @Test
    @DisplayName("Should not be able to fetch all courses if authorization token is invalid")
    public void should_not_be_able_to_fetch_all_courses_if_authorization_token_is_invalid() throws Exception {
        ResultActions result = this.mvc.perform(MockMvcRequestBuilders.get("/courses")
                .header("Authorization", "d2dx23zqr23fc24mu78cx9qwWmv2cçAc2t3mfOt2ÇzExm0mvcKrt6ACSmcQdwEm50kc0kmCkc"));
    ...
    @Test
    @DisplayName("Should not be able to fetch courses by user enrollments if authorization token is invalid")
    public void should_not_be_able_to_fetch_courses_by_user_enrollments_if_authorization_token_is_invalid() throws Exception {
        ResultActions result = this.mvc.perform(MockMvcRequestBuilders.get("/courses/subscribed")
                .header("Authorization", "d2dx23zqr23fc24mu78cx9qwWmv2cçAc2t3mfOt2ÇzExm0mvcKrt6ACSmcQdwEm50kc0kmCkc"));
    ...
    @Test
    @DisplayName("Should not be able to create a course content if authorization token is invalid")
    public void should_not_be_able_to_create_a_course_content_if_authorization_token_is_invalid() throws Exception {
        CoursesEntity course = new CoursesEntity();
        course.setId(String.valueOf(UUID.randomUUID()));
    ...
    @Test
    @DisplayName("Should not be able to upload course content video if authorization token is invalid")
    public void should_not_be_able_to_upload_course_content_video_if_authorization_token_is_invalid() throws Exception {
        CoursesContentsEntity courseContent = new CoursesContentsEntity();
        courseContent.setId(String.valueOf(UUID.randomUUID()));
    ...
    @Test
    @DisplayName("Should not be able to update course content description if authorization token is invalid")
    public void should_not_be_able_to_update_course_content_description_if_authorization_token_is_invalid() throws Exception {
        CoursesContentsEntity courseContent = new CoursesContentsEntity();
        courseContent.setId(String.valueOf(UUID.randomUUID()));
    ...
    @Test
    @DisplayName("Should not be able to update course content video if authorization token is invalid")
    public void should_not_be_able_to_update_course_content_video_if_authorization_token_is_invalid() throws Exception {
        CoursesContentsEntity courseContent = new CoursesContentsEntity();
        courseContent.setId(String.valueOf(UUID.randomUUID()));
    ...
    @Test
    @DisplayName("Should not be able to update course content release date if authorization token is invalid")
    public void should_not_be_able_to_update_course_content_release_date_if_authorization_token_is_invalid() throws Exception {
        CoursesContentsEntity courseContent = new CoursesContentsEntity();
        courseContent.setId(String.valueOf(UUID.randomUUID()));
    ...
    @Test
    @DisplayName("Should not be able to update course content module if authorization token is invalid")
    public void should_not_be_able_to_update_course_content_module_if_authorization_token_is_invalid() throws Exception {
        CoursesContentsEntity courseContent = new CoursesContentsEntity();
        courseContent.setId(String.valueOf(UUID.randomUUID()));
    ...
    @Test
    @DisplayName("Should not be able to fetch all contents of a specific course if authorization token is invalid")
    public void should_not_be_able_to_fetch_all_contents_of_a_specific_course_if_authorization_token_is_invalid() throws Exception {
        CoursesEntity course = new CoursesEntity();
        course.setId(String.valueOf(UUID.randomUUID()));
    ...
    @Test
    @DisplayName("Should not be able to fetch all published contents of a specific course if authorization token is invalid")
    public void should_not_be_able_to_fetch_all_published_contents_of_a_specific_course_if_authorization_token_is_invalid() throws Exception {
        CoursesEntity course = new CoursesEntity();
        course.setId(String.valueOf(UUID.randomUUID()));
